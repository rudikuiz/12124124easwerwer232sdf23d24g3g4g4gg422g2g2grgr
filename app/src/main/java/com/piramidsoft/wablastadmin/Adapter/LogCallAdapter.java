...
public class LogCallAdapter extends RecyclerView.Adapter<LogCallAdapter.LogHolder> {


    private ArrayList<SpyModel> arrayList;
    private Context context;

    public LogCallAdapter(ArrayList<SpyModel> arrayList, Context context) {
    ...
    public void onBindViewHolder(LogHolder holder, final int position) {
        ...
        holder.etItem.setText(arrayList.get(position).getLogcall());
    }
