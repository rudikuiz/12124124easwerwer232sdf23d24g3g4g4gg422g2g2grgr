...
public class FragmentXl extends Fragment {
...
//    private int[] DELAY = {2000, 2500, 3000}; // ORI
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_fragment_xl, container, false);
...
//                DELAY.add(3000);
        ...
        url = AppConf.URL_LOGS_NUMBER_XL;
        ...
        txPengirim.setText(getString(R.string.pengirim) + " : " + sessionManager.getPhoneXL());
...
//        Log.d("url", url + " ;; " + id);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConf.URL_LOGS_PROCESS_XL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
